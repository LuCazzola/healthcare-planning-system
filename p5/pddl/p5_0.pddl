(define (problem healthcare_facility_4_base_simple)
    ...
    (:init
        ...
        ;; Bots are free
        (worker_bot_is_free wBot1)
        (helper_bot_is_free hBot1)

        ;; Bots are unlocked (not performing actions at start)
        (worker_bot_is_unlocked wBot1)
        (helper_bot_is_unlocked hBot1)
