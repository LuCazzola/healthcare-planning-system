(define (problem healthcare_facility_2_numeric)
    (:domain healthcare_facility_2_numeric)
    ...
    (:init
        ...
        ;; Carrier setup (using numeric fluents from domain)
        (bot_owns_carrier wBot1 carrier1)
        (= (carrier_max_capacity carrier1) 3)  ; Carrier can hold 3 boxes
        (= (carrier_cur_capacity carrier1) 0)  ; Carrier starts empty
    ...
    (:goal
        (and
            ...
            ;; Bots return to starting positions
            (at wBot1 central_warehouse)
            (at hBot1 entrance)
            (bot_is_free wBot1)
            (bot_is_free hBot1)

            ;; Carrier is empty (using numeric fluent)
            (= (carrier_cur_capacity carrier1) 0)
