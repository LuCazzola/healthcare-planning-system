(define (problem healthcare_facility_1_hard)
    ...
    (:init
        ...
        (at wBot2 surgical_block)
        (at hBot1 entrance)
        (at hBot2 reception)

        ;; Robots are at start
        (bot_is_free wBot1) (bot_is_free wBot2)
        (bot_is_free hBot1) (bot_is_free hBot2)

        ;; Boxes
        (at box1 central_warehouse) (at box2 central_warehouse)
        (box_is_empty box1) (box_is_empty box2)
        (box_on_ground box1) (box_on_ground box2)
